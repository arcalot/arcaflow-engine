...
type LifecycleStage struct {
	...
	ID string
	// FinishedKeyword specifies how to call this stage once it is complete.
	FinishedKeyword string
	// InputKeyword contains the keyword to be used from the workflow configuration. This may be empty if the stage
	// requires no input.
	InputKeyword string
...
type LifecycleStageWithSchema struct {
	...
	// InputSchema describes the schema for the required input of the current stage. This may be empty if the stage
	// requires no input.
