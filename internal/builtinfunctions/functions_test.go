...
func TestHandleTypeSchemaZip(t *testing.T) {
    ...
    //listIntTypeID := strTypeID
    //listStrTypeID := intTypeID
    ...
    myFirstObjID := myFirstObj.ID()
    //refMyFirstObj := schema.NewRefSchema("ObjectTitleRef", nil)

    //listRef := schema.NewListSchema(refMyFirstObj, nil, nil)
    //scopeListRe

    //myFirstScope := schema.NewScopeSchema(
    //	myFirstObj)
    //listScope := schema.NewListSchema(myFirstScope, nil, nil)
    ...
    testInputs := []testInput{
        ...
        //{
        //	typeArgs:       []schema.Type{listRef, constantsObj},
        //	expectedResult: joinStrs("ObjectTitleRef", "Constants"),
        //},
        {
            typeArgs:       []schema.Type{listMyFirstObj, constantsObj},
            expectedResult: joinStrs(myFirstObjID, constantsObj.ID()),
        },
        {
            typeArgs:       []schema.Type{listMyFirstObj, basicStringSchema},
            expectedResult: joinStrs(myFirstObjID, strTypeID),
        },
        {
