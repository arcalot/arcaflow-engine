...
require (
	...
	go.flow.arcalot.io/dockerdeployer v0.6.0
	go.flow.arcalot.io/expressions v0.2.1
	go.flow.arcalot.io/kubernetesdeployer v0.9.0
	go.flow.arcalot.io/pluginsdk v0.8.0
	go.flow.arcalot.io/podmandeployer v0.8.0
...
require (
	...
	go.flow.arcalot.io/testplugin v0.4.0 // indirect
